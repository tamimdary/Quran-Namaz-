                  ...
                  <button
                    onClick={() => {
                      if (confirm("আপনি কি চ্যাট হিস্ট্রি মুছে দিতে চান?")) {
                        const fresh = [
                          { role: "model" as const, text: "আসসালামু আলাইকুম! আমি 'নূরের পথ' ইসলামিক এআই সহকারী। কোরআন এবং সুন্নাহর আলোকে আপনার যেকোনো ধর্মীয় বা ইসলামিক প্রশ্নের উত্তর দিতে আমি প্রস্তুত। অনুগ্রহ করে বাংলা ভাষায় যেকোনো প্রশ্ন করুন।" }
                        ];
